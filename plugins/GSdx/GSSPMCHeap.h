...
/// Heap for allocations that would be used in a single-producer multiple-consumer queue
/// Expectations:
...
public:
	...
	class SharedPtr
	{
		...
		alignas(MIN_ALIGN) struct AllocationHeader
		{
			uint32_t size;
